...
// Source: github.com/ozoncp/ocp-tenant-api/internal/flusher (interfaces: Flusher)
...
func (m *MockFlusher) Flush(arg0 context.Context, arg1 []tenant.Tenant) []tenant.Tenant {
	m.ctrl.T.Helper()
